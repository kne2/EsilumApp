    ...
    <body id="page-top" class="dark">
        ...
        <div id="wrapper">
            ...
            c-30,16.9-45,44.4-45,82.5c0,69.4,54.6,104,163.7,104C512.3,644.2,579.7,628,655.5,595.4z" />
                ...
                <?php foreach(AlumnoController::DevolverGruposAprovadosDeAlumno() as $key => $valor) : ?>
                    <?php if($valor): ?>   
                        <li class="nav-item active">
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#a<?php echo $key?>"
                        aria-expanded="true" aria-controls="collapseUtilities">
                                <i class="fas fa-fw fa-folder"></i>
                                <span><?php echo $key?></span>
                            </a>
                                <div id="a<?php echo $key?>" class="collapse" aria-labelledby="headingUtilities"
